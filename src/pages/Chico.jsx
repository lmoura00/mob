...
import {View, Text, TouchableOpacity, StyleSheet, Image, ScrollView, Dimensions, Web} from 'react-native'
           ...
           <View style={{backgroundColor:'#334A58'}}>
               <ScrollView style={{backgroundColor:'#fff', marginBottom:15,}}>
                   ...
                   <View style={styles.containerInfor}>
                       ...
                       <View>
                           ...
                           <View style={{flexDirection:'row', marginTop:15, alignItems:'center'}}>
                            <Entypo name="instagram" size={24} color="black" style={{marginRight:10}} />
                                <TouchableOpacity onPress={()=>Linking.openURL('https://www.instagram.com/sitioseuchico1/')}>
                           ...
                           <View style={{flexDirection:'row', marginTop:15, alignItems:'center'}}>
                            <Entypo name="facebook" size={24} color="black" style={{marginRight:10}} />
                                <TouchableOpacity onPress={()=>Linking.openURL('https://www.facebook.com/sitiodoseuchico/')}>
                       ...
                       <TouchableOpacity style={styles.verRota} onPress={()=>navigation.navigate('RotaChico')}>
