...
import {View, Alert, Text, TouchableOpacity, StyleSheet, Image, KeyboardAvoidingView, ScrollView,Modal} from 'react-native'
        ...
        <ScrollView style={{backgroundColor:"#334A58",}}>
            ...
            <Modal
                ...
                <View style={{marginTop:180, alignItems:'center', justifyContent:'center'}}>
                    <Text style={styles.title}>THAIANE</Text>
                    <Text style={styles.texto}>TOYOTA COROLLA</Text>
                    <Text style={styles.texto}>COR: PRETO </Text>
                </View>
                <Image source={{uri:'https://www.ontake.com.br/assets/images/models/corolla/colors/Corolla_PretoEclipse.png'}} style={{width:150, height:90, margin:7}}/>
                <Text style={styles.texto}>PLACA: PIX - 4571</Text>
