      ...
      <View style={styles.container}>
        ...
        >
          <View style={styles.modal2}>
            ...
            <TouchableOpacity
              onPress={() =>
                navigation.navigate("RotaGabrielly") || setAlerta(false)
              }
        ...
        <Image
          source={{
            uri: "https://www.toyota.com.br/wp-content/themes/toyota/ciclo-toyota/carros/sw4_SRX_1D6_carPage_mobile.png",
          }}
        ...
        <Text
          ...
          onPress={() => {
            Linking.openURL("http://api.whatsapp.com/send?phone=5599900000000");
          }}
        >
          (99) 9 0000 0000
        </Text>
