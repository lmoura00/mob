...
function HistoricoMot() {
  ...
  const initial = {
    latitude: -5.098669809,
    longitude: -42.835647386,
    latitudeDelta: 0.00098,
        ...
        {historico ? (
          <FlatList
            ...
            renderItem={({ item }) => (
              <TouchableOpacity
                style={styles.botao}
                onPress={() => navigation.navigate("DetHistoricoMot", { item })}
              >
          ...
          <FlatList
            ...
            renderItem={({ item }) => (
              <TouchableOpacity
                style={styles.botao}
                onPress={() =>
                  navigation.navigate("DetalhesHistorico", { item })
                }
              >
                <View style={{ width: 50, height: 50, left: 25 }}>
                  {item.image ? (
...
function MyTabs() {
  return (
    ...
    >
      <Tab.Screen
        name="HistoricoPax"
        component={HistoricoPax}
        options={{
          headerShown: false,
          tabBarActiveBackgroundColor: "#b9b9b9",
          tabBarLabel: "Passageiro",
        }}
      />
      <Tab.Screen
        name="HistoricoMot"
        component={HistoricoMot}
        options={{
          headerShown: false,
          tabBarActiveBackgroundColor: "#b9b9b9",
