...
export function HistoricoJose21(){
    ...
    return(
        <ScrollView style={{backgroundColor:"#334A58",}}>
            <View style={styles.container}>
                    ...
                    >
                        <View style={styles.modal2}>
                            <Text style={styles.titleModal}>ALERTA</Text>
                                ...
                                <TouchableOpacity 
                                    onPress={()=>navigation.navigate('RotaJose2') || setAlerta(false)} 
                ...
                <Image source={{uri:'https://inovaisencoes.com.br/wp-content/uploads/2020/11/range-rover-velar-20MY-1.png'}} style={{width:150, height:90, margin:7}}/>
                ...
                <KeyboardAvoidingView style={{flexDirection:'row'}}>
                    ...
                    <Text style={styles.inicioLugar}>Formosa 15:00 hrs</Text>
                </KeyboardAvoidingView>

                <KeyboardAvoidingView style={{flexDirection:'row'}}>
                    <Text style={styles.DestinoNome}>CHEGADA:</Text>
