...
export function HistoricoMariana2(){
        ...
        <ScrollView style={{backgroundColor:"#334A58",}}>
            ...
            <LottieView source={require('../../Assets/95740-profile-person.json')} autoPlay={true} loop={true} style={{marginBottom:240}}/>
                ...
                <KeyboardAvoidingView style={{flexDirection:'row'}}>
                    ...
                    <Text style={styles.inicioLugar}>IFMA CAMPUS TIMON 22:00 h</Text>
                </KeyboardAvoidingView>

                <KeyboardAvoidingView style={{flexDirection:'row'}}>
                    <Text style={styles.DestinoNome}>CHEGADA:</Text>
                    <Text style={styles.DestinoLugar}>Campo do totó 22:45 h</Text>
                </KeyboardAvoidingView>
