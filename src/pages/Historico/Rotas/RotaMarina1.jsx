...
export function RotaMarina1() {
  const mapEl = useRef(null);
  const [location, setLocation] = useState(null);
  const partida = {
    latitude: -5.118836807167505,
    longitude: -42.82463727556615,
    latitudeDelta: 0.0922,
    longitudeDelta: 0.0421,
  };
  const destination = {
    latitude: -5.105774416078441,
    longitude: -42.75391901772511,
  };
  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        />
        <Marker coordinate={partida} />
        <Marker pinColor={"#14BC9C"} coordinate={destination} />
      </MapView>
      <View
