           ...
           <View style={{backgroundColor:'#334A58'}}>
               <ScrollView style={{backgroundColor:'#fff', marginBottom:15,}}>
                        ...
                        <Modal
                            ...
                            >
                                <View style={styles.modal}>
                                    ...
                                    <Text style={styles.textoModal}>É o lugar tranquilo com água geladinha, com riachos com água corrente. </Text>
                                    <Text style={styles.textoModal}>Perfeito para familia, e para descansar depois de uma semana puxada. </Text>
                                    <Text style={styles.textoModal}>Temos restaurantes que possuem comidas deliciosas e acessíveis.</Text>
                   ...
                   <View style={styles.containerInfor}>
                       ...
                       <View>
                           ...
                           <View style={{flexDirection:'row', marginTop:15, alignItems:'center'}}>
                            <Entypo name="instagram" size={24} color="black" style={{marginRight:10}} />
                                <TouchableOpacity onPress={()=>Linking.openURL('https://www.instagram.com/balnearioroncador/')}>
                           ...
                           <View style={{flexDirection:'row', marginTop:15, alignItems:'center'}}>
                            <Entypo name="facebook" size={24} color="black" style={{marginRight:10}} />
                                <TouchableOpacity onPress={()=>Linking.openURL('https://www.facebook.com/balneario.roncador.79/')}>
                       ...
                       <TouchableOpacity style={styles.verRota} onPress={()=>navigation.navigate('RotaRoncador')}>
