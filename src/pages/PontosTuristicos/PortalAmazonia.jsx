           ...
           <View style={{backgroundColor:'#334A58'}}>
               <ScrollView style={{backgroundColor:'#fff', marginBottom:15,}}>
                        ...
                        <Modal
                            ...
                            >
                                <View style={styles.modal}>
                                    ...
                                    <Text style={styles.textoModal}>Assim pode ser definido o Portal da Amazônia, o maior clube-hotel da região meio-norte do Brasil.</Text>
                                    <Text style={styles.textoModal}> Mais de 60 hectares de lazer, relaxamento e paz, em meio à natureza em plena zona de transição da mata dos cocais e a Amazônia.</Text>
                                    <TouchableOpacity 
                   ...
                   <View style={styles.containerInfor}>
                       ...
                       <View>
                           <Text style={styles.middle}>⬤ VENHA CONHECER O MELHOR HOTEL FAZENDA DA REGIÃO</Text>
                           <Text style={styles.middle}>⬤ Seu lugar no meio da Natureza</Text>
                           <Text style={styles.middle}>⬤ Funcionamento de Terça a Domingo </Text>
                           <Text style={styles.middle}>⬤ Das 8h às 17h </Text>

                           <View style={{flexDirection:'row', marginTop:15, alignItems:'center'}}>
                            <Entypo name="instagram" size={24} color="black" style={{marginRight:10}} />
                                <TouchableOpacity onPress={()=>Linking.openURL('https://www.instagram.com/portaldaamazonia/')}>
                           ...
                           <View style={{flexDirection:'row', marginTop:15, alignItems:'center'}}>
                            <Entypo name="facebook" size={24} color="black" style={{marginRight:10}} />
                                <TouchableOpacity onPress={()=>Linking.openURL('https://www.facebook.com/PortaldaAmazoniaClube/')}>
                                    <Text style={styles.link}>Hotel Fazenda Portal da Amazônia</Text>
                                </TouchableOpacity>
                           </View>
                           
                           <View style={{flexDirection:'row', marginTop:15, alignItems:'center'}}>
                           <MaterialCommunityIcons name="web" size={24} color="black" style={{marginRight:10}} />
                                <TouchableOpacity onPress={()=>Linking.openURL('https://portaldaamazoniaclube.com.br/')}>
                                    <Text style={styles.link}>https://portaldaamazoniaclube.com.br/</Text>
                                </TouchableOpacity>
                           </View>
                       ...
                       <Text style={styles.taxa1}>DOMINGO/FERIADOS = R$35 ~ R$50 por pessoa</Text>

                       <TouchableOpacity style={styles.sobre} onPress={()=>setVisible(true)}>
                           <Text style={styles.textoBotao}>SOBRE</Text>
                       </TouchableOpacity>

                       <TouchableOpacity style={styles.verRota} onPress={()=>navigation.navigate('RotaPortalAmazonia')}>
