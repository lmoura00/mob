...
import {View, Modal, Text, StyleSheet, TextInput, TouchableOpacity, Alert, Image, ScrollView} from 'react-native'
                ...
                <Modal
                    ...
                    >
                        <View style={styles.modal}>
                            <Text style={styles.titleModal}>DESEJA SAIR SEM ATUALIZAR SEUS DADOS?</Text>
                            <TouchableOpacity 
                                onPress={()=>Alert.alert('Seus dados não foram alterados.')=== setVisible(false)} 
